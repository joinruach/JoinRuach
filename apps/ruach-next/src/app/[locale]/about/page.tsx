...
export default async function About({
  ...
  const storyImageDesktop = process.env.NEXT_PUBLIC_ABOUT_STORY_IMAGE
    ...
    : "https://cdn.joinruach.org/ruach_ministries960x2480_216560f052.png";
  ...
  const storyImageMobile = process.env.NEXT_PUBLIC_ABOUT_STORY_IMAGE_MOBILE
    ...
    : "https://cdn.joinruach.org/ruach_ministries1200x960_0eb8dc2b38.png";
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="rounded-2xl border border-amber-300/40 bg-amber-500/10 p-4 text-sm text-zinc-900 dark:text-white">
      ...
      <section className="rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-10 text-zinc-900 dark:text-white">
        <span className="text-xs uppercase tracking-[0.35em] text-zinc-500 dark:text-white/60">🕊️ Who We Are</span>
        <h1 className="mt-4 text-3xl font-semibold text-zinc-900 dark:text-white">Ruach Ministries</h1>
        ...
        <div className="mt-6 flex flex-wrap gap-3 text-sm text-zinc-600 dark:text-white/70">
      ...
      >
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Mission</h3>
          ...
          <div className="rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">Vision</h3>
            <p className="mt-3 text-sm text-zinc-600 dark:text-white/70">
      ...
      >
        <div className="grid gap-8 md:grid-cols-[1.1fr,0.9fr]">
          <div className="space-y-6 text-sm text-zinc-600 dark:text-white/70">
            <p>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">🕊️ The Birth of Ruach</h3>
              ...
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">🔥 The Mission and Vision</h3>
                <p className="mt-2 text-zinc-600 dark:text-white/70">
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-zinc-500 dark:text-white/60">
              ...
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">👥 Gather the Remnant</h3>
                <p className="mt-2 text-zinc-600 dark:text-white/70">
              ...
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">💎 The Ruach Philosophy: Bride Over Beast</h3>
                <p className="mt-2 text-zinc-600 dark:text-white/70">
              ...
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">📖 The Remnant Canon</h3>
                <p className="mt-2 text-zinc-600 dark:text-white/70">
              ...
              <div>
                <h3 className="text-base font-semibold text-zinc-900 dark:text-white">🌍 A Living Story</h3>
                <p className="mt-2 text-zinc-600 dark:text-white/70">
          ...
          <div className="overflow-hidden rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5">
            {storyImageDesktop ? (
              ...
              <div className="flex h-full min-h-[240px] items-center justify-center text-sm text-zinc-500 dark:text-white/50">
      ...
      <Section title="The Ruach Mandate" description="Ruach carries a threefold mantle:">
        <ul className="space-y-3 text-sm text-zinc-600 dark:text-white/70">
          {mandate.map((item) => (
            <li key={item} className="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-4">
              {item}
            </li>
          ))}
        </ul>
      ...
      <Section title="Leadership & Accountability" description="Ruach Ministries is accountable to a board that safeguards theology, finances, and culture.">
        <div className="grid gap-6 md:grid-cols-3">
          {board.map((member) => (
            <div key={member.name} className="rounded-3xl border border-zinc-200 dark:border-white/10 bg-white dark:bg-white/5 p-6">
              {member.photo ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={member.photo} alt={member.name} className="mb-4 h-32 w-full rounded-2xl object-cover" />
              ) : null}
              <div className="text-lg font-semibold text-zinc-900 dark:text-white">{member.name}</div>
              <div className="text-xs uppercase tracking-wide text-zinc-500 dark:text-white/50">{member.role}</div>
              <p className="mt-3 text-sm text-zinc-600 dark:text-white/70">{member.bio}</p>
            </div>
          ))}
        </div>
      </Section>
      ...
      <Section title="Statement of Faith">
        <ol className="space-y-3 text-sm text-zinc-600 dark:text-white/70">
