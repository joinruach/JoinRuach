  ...
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="space-y-4">
        <div className="h-10 w-32 bg-white dark:bg-white/10 rounded" />
        <div className="flex gap-3">
          <div className="flex-1 h-12 bg-white dark:bg-white/10 rounded-full" />
          <div className="h-12 w-32 bg-white dark:bg-white/10 rounded-full" />
        </div>
        <div className="flex gap-2">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-8 w-24 bg-white dark:bg-white/10 rounded-full" />
          ))}
        </div>
      </div>
