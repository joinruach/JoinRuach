...
function PathwayCard({ icon, title, description, link }: { icon: string; title: string; description: string; link: string }) {
  return (
    <Link href={link}>
      <div className="group rounded-3xl border border-white/10 bg-white/5 p-6 transition-all hover:border-amber-300/30 hover:bg-white/10">
  ...
  return (
    <div className="space-y-12">
      ...
      <section className="rounded-3xl border border-white/10 bg-white/5 p-10 text-white">
        <span className="text-xs uppercase tracking-[0.35em] text-white/60">🕊️ Start Here</span>
        <h1 className="mt-4 text-3xl font-semibold text-white">Welcome to Ruach</h1>
      ...
      <Section title="Who This Is For">
        <div className="space-y-4 text-sm text-white/70">
          ...
          <div className="mt-6 space-y-3">
            <p className="text-white/80">You may be:</p>
      ...
      <Section title="What Makes Ruach Different?">
        ...
        <ul className="space-y-3 text-sm text-white/70">
          <li className="rounded-2xl border border-white/10 bg-white/5 p-4">
            <strong className="text-white">No hype.</strong> Only truth, power, and presence.
          </li>
          <li className="rounded-2xl border border-white/10 bg-white/5 p-4">
            <strong className="text-white">No celebrity.</strong> Only the testimony of Jesus and the glory of His name.
          </li>
          <li className="rounded-2xl border border-white/10 bg-white/5 p-4">
            <strong className="text-white">No passive consumption.</strong> Everything here is designed to activate, not just inspire.
          </li>
        </ul>
        <p className="mt-6 text-sm text-white/70">
          Ruach operates under a Kingdom philosophy we call <strong className="text-white">Bride Over Beast</strong>—building on truth, discernment, and mission instead of control, manipulation, and entertainment. We value intimacy over influence, sending over sitting, and faithfulness over reach.
        </p>
      ...
      <section className="rounded-3xl border border-amber-300/30 bg-amber-500/10 p-8 text-center">
        <h2 className="text-2xl font-semibold text-white">Ready?</h2>
        ...
        <p className="mt-8 text-xs text-white/60">
          <strong>Ruach Ministries</strong>
          <br />
