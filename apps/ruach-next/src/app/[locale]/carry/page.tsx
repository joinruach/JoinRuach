...
export default async function CarryTheFire({
  ...
  return (
    <div className="space-y-12">
      {/* Hero Section */}
      <section className="rounded-3xl border border-amber-300/30 bg-amber-500/10 p-10 text-white">
        <span className="text-xs uppercase tracking-[0.35em] text-amber-300/80">🔥 Carry the Fire</span>
        <h1 className="mt-4 text-3xl font-semibold text-white">A Builder & Sender Invitation</h1>
      ...
      <Section title="This Is Not for Everyone (And That's Okay)">
        <div className="space-y-4 text-sm text-white/70">
          ...
          <div className="mt-6 space-y-3">
            <p className="text-white/80">You've been asking questions like:</p>
          ...
          <p className="mt-4 rounded-2xl border border-amber-300/30 bg-amber-500/10 p-4 text-white/90">
      ...
      <Section title="What It Means to Build with Ruach">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Share the Same Foundation</h3>
            <ul className="mt-4 space-y-2 text-sm text-white/70 pl-5">
              <li className="flex items-start gap-2">
                <span className="mt-1 text-amber-300">•</span>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Adapt the Model to Your Context</h3>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Build in Relationship, Not Isolation</h3>
            <p className="mt-4 text-sm text-white/70">
      ...
      >
        <div className="grid gap-8 md:grid-cols-2">
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">✅ What Ruach Will Do</h3>
            <ul className="space-y-3">
              <CheckItem type="will">
                <strong className="text-white">Equip you spiritually and practically.</strong> You can access our courses, testimonies, and frameworks. Use them. Teach them. Adapt them. We ask only that you steward what you use with integrity, accountability, and faithfulness to Scripture.
              </CheckItem>
              <CheckItem type="will">
                <strong className="text-white">Walk with you relationally.</strong> If you reach out, we'll connect. We'll listen, advise, and pray. We're not building an empire—we're equipping laborers.
              </CheckItem>
              <CheckItem type="will">
                <strong className="text-white">Share what we know.</strong> We've learned a lot building this ministry (media production, discipleship design, outreach strategy, tech infrastructure). We'll share openly what's helped us.
              </CheckItem>
              <CheckItem type="will">
                <strong className="text-white">Celebrate what God does through you.</strong> When you carry the fire and see breakthrough, we want to hear about it. Your fruit glorifies the same King.
              </CheckItem>
            </ul>
          </div>

          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">❌ What Ruach Won't Do</h3>
            <ul className="space-y-3">
              <CheckItem type="wont">
                <strong className="text-white">We won't fund your vision.</strong> Ruach is a nonprofit. We steward what God has entrusted to us, and we trust God to provide for what He's calling you to build.
              </CheckItem>
              <CheckItem type="wont">
                <strong className="text-white">We won't oversee or manage you.</strong> You answer to the Lord and your local covering, not to Ruach. We're not a denomination or network headquarters.
              </CheckItem>
              <CheckItem type="wont">
                <strong className="text-white">We won't guarantee scale or success.</strong> Faithfulness is the win. Some plantings grow fast. Some grow slow. Some bear fruit you'll never see this side of eternity. Obedience is what matters.
              </CheckItem>
              <CheckItem type="wont">
                <strong className="text-white">We won't make you us.</strong> You're not joining Ruach's staff or becoming a "Ruach chapter." You're being sent by the same Spirit to do Kingdom work in your context.
              </CheckItem>
            </ul>
          </div>
        </div>
      ...
      <Section title="The Responsibility You Carry">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Will Be Tested</h3>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Will Be Accountable</h3>
            <p className="mt-3 text-sm text-white/70">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Will Need to Die to Self</h3>
            <p className="mt-3 text-sm text-white/70">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h3 className="text-lg font-semibold text-white">You Will Have to Persevere</h3>
            <p className="mt-3 text-sm text-white/70">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-amber-500/20 text-lg font-bold text-amber-300">
                1
              </div>
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white">Reach Out</h3>
                <p className="mt-2 text-sm text-white/70">
                  Send us a message through our <Link href="/contact"><span className="text-amber-300 hover:text-amber-200 underline">contact page</span></Link>. Tell us:
                </p>
                <ul className="mt-3 space-y-1 text-sm text-white/70 pl-5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 text-amber-300">•</span>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white">Get to Know Ruach Deeply</h3>
                <p className="mt-2 text-sm text-white/70">
                ...
                <ul className="mt-3 space-y-1 text-sm text-white/70 pl-5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1 text-amber-300">•</span>
                    <span>Watch testimonies. Take courses. Read our <Link href="/about"><span className="text-amber-300 hover:text-amber-200 underline">About page</span></Link>.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1 text-amber-300">•</span>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-white">Build Relationship Over Time</h3>
                <p className="mt-2 text-sm text-white/70">
      ...
      <Section title="A Final Word">
        <div className="space-y-4 text-sm text-white/70">
          <p>
            Ruach Ministries exists to form, equip, and <strong className="text-white">send</strong>.
          </p>
          <p>
          ...
          <p className="mt-6 text-base text-white/90">
            <strong>The question is not whether you're capable.</strong>
            <br />
            <strong>The question is whether you're called.</strong>
          </p>
          <p className="mt-4">
      ...
      {/* Ready CTA */}
      <section className="rounded-3xl border border-amber-300/30 bg-amber-500/10 p-8 text-center">
        <h2 className="text-2xl font-semibold text-white">Ready to Take the Next Step?</h2>
        <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm">
          <Link href="/contact">
            <span className="inline-block rounded-full bg-amber-500/30 px-8 py-3 font-semibold text-white transition-all hover:bg-amber-500/40">
              Contact Us
            </span>
          </Link>
          <Link href="/about">
            <span className="inline-block rounded-full bg-white/10 px-6 py-3 font-medium text-white transition-all hover:bg-white/20">
              Read Our Story
            </span>
          </Link>
          <Link href="/courses">
