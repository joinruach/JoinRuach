...
export default function Header() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-subtle bg-white/95 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/80 md:dark:bg-zinc-900">
