...
export const AssetSchema = z.object({
  ...
  r2_proxy_url: z.string().nullable().optional(),
  r2_mezzanine_url: z.string().nullable().optional(),
  r2_audio_wav_url: z.string().nullable().optional(),
  transcodingStatus: z.enum(['pending', 'processing', 'complete', 'failed']).nullable().optional(),
  uploadStatus: z.enum(['pending', 'uploading', 'complete', 'failed']).nullable().optional(),
  durationMs: z.number().nullable().optional(),
  createdAt: z.string(),
  updatedAt: z.string(),
});
