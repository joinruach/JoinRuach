const securityHeaders = [
  {
    ...
    value: `
      ...
      connect-src 'self' https://cdn.joinruach.org https://*.r2.cloudflarestorage.com https://api.convertkit.com https://plausible.io https://apparent-caribou-35103.upstash.io;
    `
      .replace(/\s{2,}/g, " ")
      .trim(),
  },
