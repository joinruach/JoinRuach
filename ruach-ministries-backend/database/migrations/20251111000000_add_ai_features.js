...
module.exports = {
   ...
   */
  async up(knex) {
    console.log('📦 Phase 4: Adding AI features tables...');
    ...
    console.log('✅ Created content_embeddings table');
    ...
    if (isPostgres) {
      ...
      console.log('✅ Added pgvector embedding column and index');
    } else {
      ...
      console.log('⚠️  Using JSON text for embeddings (SQLite - dev only)');
    }
    ...
    console.log('✅ Created transcription_jobs table');
   ...
   */
  async down(knex) {
    console.log('🔄 Rolling back Phase 4 AI features...');
